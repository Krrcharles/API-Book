...
class BookCollectionDtoTest {
    ...
    void testDefaultConstructorAndSetters() {
        ...
        assertEquals(books, dto.getBooks(), "Books list should match the provided list");
    }
    ...
    void testConstructorWithId() {
        ...
        BookCollectionDto dto = new BookCollectionDto(2L, "Another Collection", 0.65, 0.70, books);
    ...
    void testConstructorWithoutId() {
        ...
        List<BookDto> books = Arrays.asList(book1);
        BookCollectionDto dto = new BookCollectionDto("Third Collection", 0.55, 0.60, books);
